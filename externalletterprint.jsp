...
<body>
	...
	<img src="./imgs/letterhead.jpg" align=center style="float: center;"></img>
		...
		<p style="text-align:left;margin-left: 55px;margin-right: 75px;">
 			<%=ref %> 
		...
		<p align=center>Sub: Appointment of External Examiner - Reg</p>
		<br>
		<p style = "margin-left: 35px;margin-right: 75px;"> In continuation of our telephonic request on conducting the <b>Practical/Lab  examination and Theory paper valuation  </b>for
		<%=course %> students in our college, I hereby wish to convey my thanks for immediately accepting our Invitation.
</p><br>
<p style = "margin-left: 35px;margin-right: 75px;">
I hereby invite you as an External Examiner to conduct the following Examination, as mentioned below.
</p>
    ...
    <ul>
	    ...
	    <li>Valued  Answer scripts of Practical examination are to be maintained by the Internal Examiner. and marks lists to be handover to the Controller of Examinations, Sri Vishnu College of Pharmacy, Bhimavaram.
	</ul>
