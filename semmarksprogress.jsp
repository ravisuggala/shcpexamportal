...
<!--
document.writeln("<br><br><br><br><br><br><center><h3>Semester Marks Details is Preparing....Please Wait..<br></br></h3></center>");
setTimeout("location.href = '././ActionServlet?option=semmarks';",150);
-->
</script>
