...
else
{
	degree=miscUtil.noNull(request.getParameter("degree"));
	 ...
	 students=stdb.getStudentListAy(degree, branch, sem,section,ay); 
	...
	if(!validsec&&!utype.equals("admin"))
	{
	...
	if(!utype.equals("admin"))
		 freez=new MidExamDB().isMidFreeze(sem,degree,ay,midno);
	...
	{
		session.putValue("option", "assmarksstep2");
