...
if (session.getAttribute("marksinput")!=null)
{
	 ...
	 out.println("<center><h6>"+status+"</h6></center>");
		%>
		 <jsp:include page='./externalmarksstatus.jsp' flush="true" />
	    <% 
}
else
{
 ...
 entry=miscUtil.getFromSession(request, response,"entry");
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="300">
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "externalmarks">
