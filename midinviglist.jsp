...
ArrayList subjectsList=new MidExamDB().findAllMidDates(degree, branch, sem, ay, midno);
...
function selectFaculty(index)
{
 var selvalue=document.getElementById('fdv'+index).value;
	...
	<body>
		  <div id="centre">
			    <center><h1>Mid Invigilation Preparation </h1></center>
			    <CENTER>
			    <%
			    ...
			    %>
			    <FORM NAME = REGISTER METHOD = POST ACTION = "./midinvigreport.jsp" target="_blank">
							...
							<TR>
							    ...
							    <Th nowrap>Selected Faculty List</TH>
									...
									<%
										...
										{
											TestDates sub=(TestDates)subjectsList.get(i);
											String selectName="f-"+sub.getSubcode();
									%>
									<tr>
									<td nowrap><%=sub.getTest(midno) %>
