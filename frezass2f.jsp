...
String fid="";
	...
	session.putValue("option", "frezassf");
...
<!--
document.writeln("<br><br><br><br><br><br><center><h3>Internal Evaluation Marks are finalizing....Please Wait..<br></br></h3></center>");
setTimeout("location.href = '././ActionServlet?option=frezassf';",150);
-->
</script>
