...
String assmax=miscUtil.getFromSession(request, response,"acaactmax");
...
for(int i=0;i<mapids.size();i++)
{
	...
	{
		attbox="<input id=asst"+i+" type=text size=5 maxlength=5 name="+mapid+"-asst value="+attempted.getActvts()+"></input>";
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="300">
							...
							<th class=label nowrap><font size=1>Academic Activities Marks<br>(<%=assmax %>)</font>
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "acaactmarks">
