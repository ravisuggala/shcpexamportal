		  ...
		  <div id="centre">
					    ...
					    <CENTER>
							...
							<TR>
								...
								<select name="fromsem">
								<option></option>
									<option value="1" <%=fromsem.equals("1")?"SELECTED":"" %>>1</option> 
        							<option value="2" <%=fromsem.equals("2")?"SELECTED":"" %>>2</option> 
        							<option value="3" <%=fromsem.equals("3")?"SELECTED":"" %>>3</option> 
        							<option value="4" <%=fromsem.equals("4")?"SELECTED":"" %>>4</option> 
        							<option value="5" <%=fromsem.equals("5")?"SELECTED":"" %>>5</option>
        							<option value="6" <%=fromsem.equals("6")?"SELECTED":"" %>>6</option>
        							<option value="7" <%=fromsem.equals("7")?"SELECTED":"" %>>7</option>
        							<option value="8" <%=fromsem.equals("8")?"SELECTED":"" %>>8</option>
        							</select></TD></TR>
        					<TR>
								...
								<select name="tosem">
								<option></option>
									<option value="1" <%=tosem.equals("1")?"SELECTED":"" %>>1</option> 
        							<option value="2" <%=tosem.equals("2")?"SELECTED":"" %>>2</option> 
        							<option value="3" <%=tosem.equals("3")?"SELECTED":"" %>>3</option> 
        							<option value="4" <%=tosem.equals("4")?"SELECTED":"" %>>4</option> 
        							<option value="5" <%=tosem.equals("5")?"SELECTED":"" %>>5</option>
        							<option value="6" <%=tosem.equals("6")?"SELECTED":"" %>>6</option>
        							<option value="7" <%=tosem.equals("7")?"SELECTED":"" %>>7</option>
        							<option value="8" <%=tosem.equals("8")?"SELECTED":"" %>>8</option>	</select></TD></TR>
        					<TR>
