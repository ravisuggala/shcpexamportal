...
function validateMarks(field) 
{
	var i;
	 ...
	 var patt1 = new RegExp("^(a|A|[0-9]|1[0-9]|2[0-9]|3[0-9]|4[0-9]|5[0-9]|6[0-9]|7[0-9]|8[0-9]|9[0-9]|10[0-9]|11[0-9]|12[0-5])$");
...
for(int i=0;i<mapids.size();i++)
{
	...
	MidExam attempted=medb.findMapidinExternal(mapid,examname);
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="300">
							...
							<th><font size=1>Practice School Marks(125)</font>
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "externalps3marks">
