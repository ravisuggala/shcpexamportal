...
function toggle(selectObj) {
	...
	var urlString ="./labsubjectsf.jsp?degree="+degree+"&branch="+branch+"&sem="+sem+"&section="+section+"&ay="+ay+"&faculty="+faculty+"&reg="+reg ;
	$.ajax({
	type: "POST",
	url: urlString ,
...
function fesubjectselect(elecat)
{
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Lab Examinations Marks Excel Report</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./labexcelprogress.jsp">
