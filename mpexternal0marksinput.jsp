...
for(int i=0;i<mapids.size();i++)
{
	...
	{
		dmbox="<input  type=text size=3 maxlength=5 name="+mapid+"-dm-"+examname+" value='##''></input>";
	...
	{
	     dmbox="<input   type=text maxlength=5 value='##' size=3 name="+mapid+"-dm-"+examname+"></input>";
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="300">
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "mpexternal0marks">
