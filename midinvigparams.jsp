...
function loadfaculty(selectObj,index) {
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Mid Time Table Preparation</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./midinviglist.jsp">
							...
							<TR>
								...
								<td WIDTH="10%" ALIGN="left">
								<select id="reg" name="reg" onChange=>
								<option value="-">-</option>
				...
				src="imgs/datepicker.gif" /></td>
							...
							<tr>
							<td nowrap align=right>Time of Examination</td>
							<td nowrap><input type=time name=from></input> to <input type=time name=to></input></td>
