...
Student st=new StudentDB().getSubjectsForRegistration(regdno,sem,"REGULAR");
if(st==null)
{
	
	String status="Error!!No Student Details found (or) Already Registered for Examination";
...
<body>
	<div id="centre">
		...
		<CENTER>
			<FORM NAME=REGISTER METHOD=POST ACTION="./regregistration3.jsp" onsubmit="return confirm('Are you sure?');" >
...
<td>
				...
				<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="350">
					<TR>
						<TD COLSPAN="2" ALIGN="center"><h5>	<b> List of Subjects to be registered</b></h2></TD>
					</TR>
					<TR>
