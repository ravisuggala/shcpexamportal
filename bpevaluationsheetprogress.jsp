...
<!--
document.writeln("<br><br><br><br><br><br><center><h3>B.Pharmacy Evaluations Sheet is Preparing....Please Wait..<br></br></h3></center>");
setTimeout("location.href = '././ActionServlet?option=bpevaluationsheet';",150);
-->
</script>
