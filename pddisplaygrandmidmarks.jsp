...
<jsp:include page='<%= header %>' flush="true" />
	...
	<body>
		  <div id="centre">
				...
				<tr>
			    <th colspan=9 style="text-align: center;">SHRI VISHNU COLLEGE OF PHARMACY:BHIMAVARAM<BR>(AUTONOMOUS) </th>
			    </tr>
			    ...
			    <TR>
				   <TD COLSPAN="9" ALIGN="center"><h6><b> Student List</b></h6></TD>
							...
							<th nowrap><font size=1 >III Mid</font>
							<th><font size=1>Re Mid</font>
							<th><font size=1 nowrap>Scaled to 20</font>
