...
function loadfaculty(selectObj,index) {
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Acceptance Letter to Internal Examiner</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./examinerletterprint.jsp" target="_blank">
        					...
        					<tr>
        					<td nowrap>Faculty Department</td>
        					<td nowrap><select size=1 id=dept1 name=dept1 onChange="loadfaculty(this,'1')">
										  <option value=""></option>
  										<option value="Pharmaceutics" >Pharmaceutics</option> 
  										<option value="Pharmacology">Pharmacology</option>
							...
							<td nowrap>
									...
									<select id='fdv1' name='fname'></select>
							</tr>
							<tr>
							<td nowrap>Address of the faculty</td>
							<td>
