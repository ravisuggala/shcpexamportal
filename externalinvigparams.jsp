...
<html>
	<head>
		...
		function populateSecValues(obj){
			...
			var urlString ="./examinationnames.jsp?course="+course+"&sem="+sem+"&ay="+ay+"&reg="+reg+"&type="+type+"&period="+period ;
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>External Examination Invigilation Report</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./externalinviglist.jsp" target="_blank">
							...
							<TR>
								...
								<option></option>
									...
									<option value="Reg/Supple">Reg/Supple</option>
