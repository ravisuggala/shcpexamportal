...
<!--
document.writeln("<br><br><br><br><br><center><h3>Continuous Evaluation Marks are finalizing....Please Wait..<br></br></h3></center>");
setTimeout("location.href = '././ActionServlet?option=cefreezeprogress';",150);
-->
</script>
