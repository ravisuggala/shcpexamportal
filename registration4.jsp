...
<title> SVCP -- Examination Registrations</title>
...
<br> <br><a href="./registration1.jsp?type=<%=st.getType() %>" > Click here for another <%=st.getType() %> Examination Registration</a></font> 
		</CENTER>
