...
<br></br>
<FORM NAME = REGISTER METHOD = POST ACTION = "./internalStep1session.jsp">
		<INPUT TYPE=HIDDEN NAME="hiddenActionType" VALUE = "storemarks">
	</FORM>

<FORM NAME = REGISTER1 METHOD = POST ACTION = "./internalStep1.jsp">
		<INPUT TYPE=HIDDEN NAME="hiddenActionType" VALUE = "storemarks">
	</FORM>
...
<FORM NAME = REGISTER1 METHOD = POST ACTION = "./internalStep1f.jsp">
		<INPUT TYPE=HIDDEN NAME="hiddenActionType" VALUE = "storemarks">
	</FORM>
