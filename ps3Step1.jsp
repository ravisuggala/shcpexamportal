...
function toggle(selectObj) {
	...
	var reg=document.getElementById("reg").value;
		...
		var urlString ="./ps3subject.jsp?degree="+degree+"&branch="+branch+"&sem="+sem+"&reg="+reg ;
		$.ajax({
		type: "POST",
		url: urlString ,
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Practice School-III Internal Examinations Marks Entry</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./ps3Step2.jsp">
							<INPUT TYPE=HIDDEN NAME="hiddenActionType" VALUE = "ps3step1">
