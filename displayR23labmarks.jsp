		  ...
		  <div id="centre">
			    ...
			    <TR>
				   <TD COLSPAN="9" ALIGN="center"><h6><b> Student List</b></h6></TD>
							...
							<th nowrap><font size=1 >Practical<br>(<%=subdetails.getMidconductmarks() %>)</font>
							<th nowrap><font size=1 >Regularity<br>(<%=subdetails.getAttmax() %>)</font>
							<th><font size=1>Record<br>(<%=subdetails.getTestmax() %>) </font>
							<th><font size=1 nowrap>Viva(<%=subdetails.getAssmax() %>)</font>
