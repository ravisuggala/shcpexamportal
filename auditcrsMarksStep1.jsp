...
function toggle(selectObj) {
	...
	var reg=document.getElementById("reg").value;
		...
		var urlString ="./aucsubjects.jsp?degree="+degree+"&branch="+branch+"&sem="+sem+"&reg="+reg ;
		$.ajax({
		type: "POST",
		url: urlString ,
	...
	<body>
		  <div id="centre">
					    ...
					    <CENTER>
							...
							<FORM NAME = REGISTER METHOD = POST ACTION = "./auditcrsMarksStep2.jsp">
...
<TR>
								...
								<select id="yoa" name=yoa onChange="toggle(this);">
								<option value=""></option>
