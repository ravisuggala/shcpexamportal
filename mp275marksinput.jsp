...
function validateMarks(field) 
{
	...
	// var id=field.id;
	 ...
	 var patt = new RegExp("^(a|A|[0-9]|1[0-9]|2[0-9]|3[0-9]|4[0-9]|5[0-9]|6[0-9]|7[0-9]|8[0-9]|9[0-9]|1[0-9][0-9]|2[0-7][0-9])$");
	// var patt1 = new RegExp("^(a|A|[0-9]|1[0-9]|2[0-9]|3[0-9]|4[0-9]|5[0-9]|6[0-9]|7[0-9]|8[0-9]|9[0-9]|100)$");
...
for(int i=0;i<mapids.size();i++)
{
	...
	else
	{
			 ...
			 dmbox="<input  id=dm"+i+" type=text size=3 maxlength=3 name="+mapid+"-dm"+" value="+attempted.getDm()+"></input>";
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="300">
							...
							<th nowrap><font size=1>Marks(275)</font>
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "mp200marks">
