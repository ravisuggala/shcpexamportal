...
ArrayList marksdata=new ArrayList();
	...
	marksdata=medb.getLabMarks(ay, branch, reg, sem, subject, section,degree);

session.putValue("marksdata", marksdata);
 
title=new StudentDB().getYearDescription(sem,degree)+" Lab Examination";
