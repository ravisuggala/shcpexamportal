...
function fesubjectselect(elecat)
{
	...
	<body>
		  <div id="centre">
					    ...
					    <center><h1>Internal Assessment Marks Entry</h1></center>
					    <CENTER>
					    	<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="290">
							<FORM NAME = REGISTER METHOD = POST ACTION = "./testmarks2f.jsp">
							...
							<TR>
								<TD  WIDTH="20%" ALIGN="right">Test Number </TD>
								<td WIDTH="10%" ALIGN="left">
								...
								<option></option>
									<option value="test1">Test-I</option>
									 ...
									 <option value="test4">Test-IV</option>
        							</select> 
        						</td>
        						</tr>
							<TR>
