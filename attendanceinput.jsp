...
function validateMarks(field) 
{
	...
	var conducted=parseInt(document.getElementById("conducted").value);
	 ...
	 var asspatt = generateRegex(conducted);
	 if(id1=="attd")
		 {
		 	if(asspatt.test(value)){
...
for(int i=0;i<mapids.size();i++)
{
	...
	{
		attbox="<input id=attd"+i+" type=text size=5 maxlength=5 name="+mapid+"-att value="+attempted.getAttended()+"></input>";
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="2" CELLSPACING="2" WIDTH="300">
							...
							<th class=label nowrap><font size=1>Attended out of <br><%=conducted %> classes</font>
							<input type=hidden name="conducted" id="conducted" value=<%=conducted %>></input>
							<%
							...
							<INPUT TYPE=HIDDEN NAME="option" VALUE = "attendancemarks">
