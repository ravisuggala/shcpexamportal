...
function validateMarks(field) 
{
	var i;
	 ...
	 var patt1 = new RegExp("^(a|A|[0-9]|1[0-9]|2[0-9]|3[0-9]|3[0-9]|4[0-9]|5[0-9]|6[0-9]|70|[0-9]\.5|1[0-9]\.5|2[0-9]\.5|3[0-9]\.5|4[0-9]\.5|5[0-9]\.5|6[0-9]\.5)$");
...
for(int i=0;i<mapids.size();i++)
{
	...
	if(attempted==null)
	{
		...
		if(subobj.getCategory().equals("NUE"))
			dmbox="<input id=nm"+i+" type=text size=5 maxlength=5 name="+mapid+"-dm></input>";
		else
	...
	{
		if(subobj.getCategory().equals("NUE")) 
			dmbox="<input id=nm"+i+" type=text size=5 maxlength=5 name="+mapid+"-dm value="+attempted.getDm()+"></input>";
		else
		  ...
		  <div id="centre">
			    ...
			    <CENTER>
						<TABLE BORDER="1" CELLPADDING="1" CELLSPACING="1" WIDTH="300">
							...
							<th><font size=1>Daily Assessment Marks<br>(7)</font>
